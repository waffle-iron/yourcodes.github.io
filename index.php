...
<!--                <div class="textDiv">-->
<!--                    <p>-->
<!--                        Unirsi alla banda è semplice, basta fare una richiesta e vi invieremo via mail tutte le informazioni.-->
<!--                        <br>-->
<!--                        Per la gestione dei repository ci appoggiamo a github ed in questo modo rispettiamo facilmente l'ideale opensource-->
<!--                        <br>-->
<!--                        Se vi piace il progetto è possibile donare tramite paypal-->
<!--                    </p>-->
<!--                </div>-->
<!--                <div class="imageDiv">-->
<!---->
